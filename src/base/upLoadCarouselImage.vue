<template>
  <div>
    <el-dialog
      ...
      <span class="lb"></span>
      <span class="rb"></span>
      <div class="upLoadImg-wrap" style="width:100%;height:500px;" draggable="true" @drop="dropDown" @dragover="defaults" @dragenter="defaults">
...
export default {
  ...
  methods: {
    ...
    look(e) {
      ...
      this.$axios
        .post(`/api/projectImage/insertProjectImage?projectId=${this.projectId}&type=1&module=1`, formData, header)
        .then(res => {
          if (res.data.code == 0) {
            this.$message({
              type: 'success',
...
.el-button:hover {
  background: #2a61d4;
  border: 1px solid #2a61d4;
}
/deep/.el-dialog__body {
  border-top: 1px solid #0e1e53;
...
.addImage {
  background-image: url(../../static/images/addImage.png);
