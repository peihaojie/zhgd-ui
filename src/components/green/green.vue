    ...
    <div id="right">
      ...
      <div class="up">
        ...
        <div class="title">
          ...
          <span class="content">
            电箱运行状态：
            <span class="noml" v-if="this.tableData.length">正常</span>
            <span class="danger" v-else>异常</span>
            <!-- <span class="danwei">&nbsp;kw/h</span> -->
          </span>
        </div>
        <div class="imgs">
          <div v-if="this.tableData.length" :class="this.tableData[0].doorType==0?'loudian':'loudian1'">
            <div class="text">
              <p style="font-size:.2rem; line-height:.45rem">{{this.tableData[0].doorType==0?'关':'开'}}</p>
            </div>
          </div>
          <div v-if="this.tableData.length" :class="this.tableData[0].envirwarm<45?'loudian':'loudian1'">
            <div class="text">
              <p>{{this.tableData[0].envirwarm}}</p>
              <p>℃</p>
            </div>
          </div>
          <div v-if="this.tableData.length" :class="this.tableData[0].current<150?'loudian':'loudian1'">
            <div class="text">
        ...
        <div class="subtitle" v-if="this.tableData.length">
