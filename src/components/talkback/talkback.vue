      ...
      <div class="video-top">
        ...
        >
          ...
          <div class="video-only" v-if="videoNum==1">
            ...
            >确定</span>
            <span class="cut-back" @click="playback=false,getIframeSrc()" v-if="playback && !isDaHua">返回</span>
            <iframe :src="iframeSrc" height="100%" width="100%" id="player17" allowfullscreen v-if="!isDaHua"></iframe>
