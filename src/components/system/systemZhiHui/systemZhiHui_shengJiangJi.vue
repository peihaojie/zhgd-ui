...
export default {
  ...
  methods: {
    ...
    // 获取历史记录
    historyRecord() {
      this.$axios.post(`/api/elevatorApi/historyRecord?hxzid=${this.equipmentData.hxzid}&pageNum=${this.pageNum}&pageSize=${this.pageSize}`).then(
        res => {
          // console.log(res.data)
    ...
    pageClick() {
      ...
      this.$axios
        .post(
          `/api/elevatorApi/historyRecord?hxzid=${this.equipmentData.hxzid}&pageNum=${this.pageNum}&pageSize=${this.pageSize}&time=${time}&endTime=${endTime}&status=${this.status}`
        )
        .then(
          res => {
            this.pageTotal = res.data.data.total
    ...
    historyRecordExcel() {
      if (this.excelDate && this.equipmentData.hxzid) {
        ...
        location.href = `http://47.106.71.3:8080/api/elevatorApi/historyRecordExcel?hxzid=${this.equipmentData.hxzid}&time=${time}&endTime=${endTime}`
